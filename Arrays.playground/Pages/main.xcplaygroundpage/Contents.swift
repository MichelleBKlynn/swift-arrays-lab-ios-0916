 ...
 */
var itemToPrint = afternoonAttendance[2]
 ...
 */
var ingredients = ["Bread", "Water", "Air"]
...
//     return ingredient == "Bread" also works below the line "let ingredient = ingredients[0]. However, it's "too clever" and may be hard to remember what it is/does/is asking later.
//
// another way, but is less ideal beause it doesn't read like a sentence:
// if 0 == ingredients.indexOf("Bread")  {
   // return true }
// else {
   // return false }
/*: question10
